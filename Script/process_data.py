...
def process_game_data(direname, filename):
    ...
    new_dirname = '/Users/Mostakim/Desktop/chess-engine/Data/CSV_BOTVINNIK'
...
for dirname, _, filenames in os.walk('/Users/Mostakim/Desktop/chess-engine/Data/PGN/Raw_game/Raw_game/Botvinnik'):
